        ...
        <div className={styled.hero_back} ></div>
          <div className={styled.hero_zakaz}>
            ...
            <div className={styled.tovar_zakaz}>
                <p className={styled.txt_zakaz1}> Товаров в заказе: <span className={styled.boldtxt_zakaz}> {items.length} шт.</span > </p>
                <p className={styled.txt_zakaz2}> Общая сумма заказа: <span className={styled.boldtxt_zakaz}> {totalbasket} ₽ </span> </p>
